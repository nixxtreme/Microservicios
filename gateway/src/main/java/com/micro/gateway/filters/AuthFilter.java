package com.micro.gateway.filters;

import com.micro.gateway.dto.TokenDto;
...
public class AuthFilter implements GatewayFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        return this.webClient.post().uri(AUTH_VALIDATE_URI).header(ACCESS_TOKEN_HEADER_NAME, token)
                .retrieve().bodyToMono(TokenDto.class).map(response -> exchange).flatMap(chain::filter);
